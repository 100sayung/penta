...
<form method="post" action="/suptman/customer/regist-customer" accept-charset="utf-8">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="cName" id="cName" value="${c.getCName()}" placeholder="고객사이름">
  </div>
  <div class="form-group">
    <label for="cAddr" class="control-label">고객사 주소*</label>
    <input type="text" class="form-control" name="cAddr" id="cAddr" value="${c.getCAddr()}" placeholder="고객사 주소">
  </div>
  <div class="form-group">
    <label for="pName" class="control-label">제품 이름*</label>
    <input type="text" class="form-control" name="pName" id="pName" value="${c.getPName()}" placeholder="제품 이름">
  </div> 
  <div class="form-group">
  </div> 
  <div class="form-group">
    <label for="ciHWOS" class="control-label">고객사 HW/OS*</label>
    <input type="text" class="form-control" name="ciHWOS" id="ciHWOS" value="${c.getCiHWOS()}" placeholder="대상 OS정보">
  </div> 
  <div class="form-group">
    <label for="ciSystem" class="control-label">대상 시스템 정보*</label>
    <input type="text" class="form-control" name="ciSystem" id="ciSystem" value="${c.getCiSystem()}" placeholder="ex.서버1대, 에이전트10대">
  </div> 
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="ciMonthly" id="ciMonthly" value="${c.getCiMonthly()}" placeholder="월 방문횟수">
  </div> 
  <div class="form-group">
    <label for="pId" class="control-label">담당엔지니어*</label>
    <input type="text" class="form-control" name="pId" id="pId" value="${c.getPId()}" placeholder="담당엔지니어">
  </div> 
  <div class="form-group">
    <label for="ciMemo" class="control-label">특이사항</label>
    <input type="text" class="form-control" name="ciMemo" id="ciMemo" value="${c.getCiMemo}" placeholder="월 방문횟수">
  </div> 
  <div class="form-group">
