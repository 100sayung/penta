...
<form method="post" action="/suptman/customer/regist-customer" accept-charset="utf-8" id="regFrm">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="cId" id="cId" placeholder="고객사 ID">
  </div> 
  <div class="form-group">
