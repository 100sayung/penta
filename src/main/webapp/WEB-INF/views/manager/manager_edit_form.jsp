...
<form method=post action="edit_manager.do" id="editFrm">
  <div class="form-group">
    <input type="hidden" name="mIndex" id="mIndex" value="${mVO.mIndex}">
    <label class="control-label" for="mCom">회사*</label>
    <input type="text" class="form-control" name="mCom" id="mCom" value="${mVO.mCom}" placeholder="회사">
  </div>
  <div class="form-group">
    <label for="mId" class="control-label">아이디*</label>
    <input type="text" class="form-control" name="mId" id="mId" value="${mVO.mId}" placeholder="아이디">
  </div>
  <div class="form-group">
    <label for="mName" class="control-label">이름*</label>
    <input type="text" class="form-control" name="mName" id="mName" value="${mVO.mName}" placeholder="이름">
  </div>  
  <div class="form-group">
    <label for="mAddr" class="control-label">주소*</label>
    <input type="text" class="form-control" name="mAddr" id="mAddr" value="${mVO.mAddr}" placeholder="주소">
  </div>
  <div class="form-group">
    <label for="mHp" class="control-label">핸드폰*</label>
    <input type="text" class="form-control" name="mHp" id="mHp" value="${mVO.mHp}" placeholder="핸드폰">
  </div>
  <div class="form-group">
    <label for="mTel" class="control-label">연락처</label>
    <input type="text" class="form-control" name="mTel" id="mTel" value="${mVO.mTel}" placeholder="연락처">
  </div>
  <div class="form-group">
    <label for="mEmail" class="control-label">이메일*</label>
    <input type="text" class="form-control" name="mEmail" id="mEmail" value="${mVO.mEmail}" placeholder="이메일">
  </div>  
  <div class="form-group">
    <label for="mTask" class="control-label">업무*</label>
    <input type="text" class="form-control" name="mTask" id="mTask" value="${mVO.mTask}" placeholder="업무">
  </div>

  <div class="form-group">
    <label for="mWorkcom" class="control-label">실제 근무지</label>
    <input type="text" class="form-control" name="mWorkcom" id="mWorkcom" value="${mVO.mWorkcom}" placeholder="실제 근무지">
  </div>
  <div class="form-group">
    <label for="mWorkemail" class="control-label">실제 이메일</label>
    <input type="text" class="form-control" name="mWorkemail" id="mWorkemail" value="${mVO.mWorkemail}" placeholder="실제 이메일">
  </div> 
  <div class="form-group">
    <label for="mMemo" class="control-label">메모</label>
    <textarea class="form-control" name="mMemo" id="mMemo" rows="5">${mVO.mMemo}</textarea>
  </div>
  <div class="form-group">
